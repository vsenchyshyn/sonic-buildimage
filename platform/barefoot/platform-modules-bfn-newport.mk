...
#$(BFN_NEWPORT_BF_PLATFORM_MODULE)_SRC_PATH = $(PLATFORM_PATH)/sonic-platform-modules-bfn-newport
#$(BFN_NEWPORT_BF_PLATFORM_MODULE)_DEPENDS += $(LINUX_HEADERS) $(LINUX_HEADERS_COMMON)
#SONIC_DPKG_DEBS += $(BFN_NEWPORT_BF_PLATFORM_MODULE)
